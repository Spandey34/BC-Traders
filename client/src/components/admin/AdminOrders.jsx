...
              {/* FIX: This container is now stabilized with a minimum height */}
              <div className="border-t pt-3 flex flex-wrap gap-2 justify-between items-center min-h-[52px]">
                <button
...
                    </button>
                  )}
                  {/* FIX: Delete button is now conditionally disabled */}
                  <button
                      onClick={() => setOrderToDelete(order)}
                      disabled={order.status === 'delivered' || order.paymentStatus === 'paid'}
                      title={order.status === 'delivered' || order.paymentStatus === 'paid' ? "Cannot delete paid or delivered orders" : "Delete Order"}
                      className="btn-action bg-red-500 hover:bg-red-600 disabled:bg-gray-400 disabled:cursor-not-allowed"
                    >
                      Delete
                  </button>
                </div>
